...
func (sv *RobotManageService) RobotCreate(ctx *gin.Context, req dto.RobotCreateRequest) error {
	...
	// 插入一条公共配置记录
	commonConf := fmt.Sprintf("INSERT INTO `%s`.`%s` (`chat_ai_enabled`, `chat_base_url`, `chat_api_key`, `workflow_model`, `chat_model`, `image_recognition_model`, `chat_prompt`, `friend_sync_cron`) VALUES (0, '%s', '%s', 'gpt-4o-mini', 'gpt-4o-mini', 'gpt-4o-mini', '%s', '55 * * * *');",
