...
type MomentsGetListResponse struct {
	...
	AdvertiseList         []byte            `json:"AdvertiseList,omitempty"`
	Session               *SKBuiltinBufferT `json:"Session,omitempty"`
...
type SnsObject struct {
	...
	BlackList            []*SKBuiltinBufferT `json:"BlackList,omitempty"`
	DeleteFlag           *uint32             `json:"DeleteFlag,omitempty"`
	GroupUserCount       *uint32             `json:"GroupUserCount,omitempty"`
	GroupUser            []*SKBuiltinBufferT `json:"GroupUser,omitempty"`
	ObjectOperations     []*SKBuiltinBufferT `json:"ObjectOperations,omitempty"`
...
type SnsRedEnvelops struct {
	...
	RewardUserList []byte  `json:"RewardUserList,omitempty"`
